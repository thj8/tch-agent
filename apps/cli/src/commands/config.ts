/**
 * config 命令组：api-keys / providers / model-prefs / prompts。
 *
 * 全部是对 ConfigManager 单例的 CRUD 包装，按 CLAUDE.md 的 CLI 约定：
 * 失败 console.error("✗ ...") + exit(1)，成功 console.log("✓ ...")。
 */
import type { Command } from "commander"
import { ConfigManager } from "@my/core"

/** 在 program 上挂载 config 命令组。 */
